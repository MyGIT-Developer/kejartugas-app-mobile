    ...
    return (
        ...
        >
            ...
            >
                ...
                <StyledContainer style={{ backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ 
                        backgroundColor: '#fff', 
                        borderRadius: 15, 
                        padding: 20, 
                        ...
                        <Text style={{ color: '#148FFF', fontSize: 18, fontWeight: '700', fontFamily: 'Poppins-Bold' }}>Log In Akun</Text>
                        <FormContainer>
                            <Input
                            ...
                            <Input
                                ...
                                style={{ fontFamily: 'Poppins-Regular' }}
                            />
                            <Text style={{ color: '#148FFF', fontSize: 13, fontWeight: '500', fontFamily: 'Poppins-Regular', marginTop: 6 }}>
                                Lupa Password?
                            </Text>
                            <SubmitButton
                                onPress={handleLogin}
